        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: "20px" }}>
            <input
              ...
              required
              placeholder="メールアドレス"
              style={{ width: "100%", padding: "10px", borderRadius: "8px", border: "1px solid #ccc", backgroundColor: "#e9f0ff" }}
            />
          </div>
          ...
          <button type="submit" style={{ width: "100%", padding: "12px", border: "2px solid #f35", borderRadius: "8px", color: "#f35", background: "white", fontWeight: "bold", cursor: "pointer" }}>
            ログイン
          </button>
        </form>
      </div>
